...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers("/login", "//login", "/roles", "//roles", "/usuarios", "//usuarios", "/usuarios/**", "//usuarios/**", "/ws/**").permitAll()
    ...
    public org.springframework.web.cors.CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOriginPatterns(java.util.Arrays.asList("http://localhost:4200", "https://*.vercel.app", "https://*.railway.app", "https://*.onrender.com"));
